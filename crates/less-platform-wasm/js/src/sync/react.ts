/**
 * React hooks for @less-platform/sync.
 *
 * Import from "@less-platform/sync/react".
 *
 ...
 *
 * Structurally compatible with `AuthSession` from `@less-platform/auth` —
...
export interface LessProviderProps {
  ...
  /** Identity domain (e.g., "less.so"). Endpoints discovered via .well-known. */
  domain?: string;
  /**

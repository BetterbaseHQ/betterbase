...
use betterbase_db::sync::types::SyncTransportError;
...
impl betterbase_db::sync::types::SyncTransport for JsSyncTransport {
    async fn push(
        &self,
        collection: &str,
        ...
        let acks: Vec<betterbase_db::sync::types::PushAck> = acks_arr
            ...
            .map(|v| {
                ...
                betterbase_db::sync::types::PushAck { id, sequence }
            })
            .collect();
    ...
    async fn pull(
        ...
        let records: Vec<betterbase_db::types::RemoteRecord> = records_val
            .iter()
            .map(|v| {
        ...
        let failures = val
            ...
            .map(|arr| {
                arr.iter()
                    .map(|v| betterbase_db::sync::types::PullFailure {
                        id: v
                            .get("id")
                            .and_then(|v| v.as_str())
                            .unwrap_or("")

 ...
 *
 * Discovery channel: BroadcastChannel("less-db:<dbName>")
 * Per-follower RPC channel: BroadcastChannel("less-db:<dbName>:rpc:<followerTabId>")
 */
